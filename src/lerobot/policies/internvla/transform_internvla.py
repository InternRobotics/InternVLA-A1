...
@DataTransformFn.register_subclass("internvl3_tokenizer")
@dataclass
...
@DataTransformFn.register_subclass("unify_internvla_inputs")
@dataclass
class UnifyInternVLAInputsTransformFn(DataTransformFn):
    def __call__(self, data: DataDict) -> DataDict: 
        data = {
