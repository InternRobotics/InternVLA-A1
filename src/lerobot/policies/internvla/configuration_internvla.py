...
from lerobot.policies.internvla.transform_internvla import InternVL3TokenizerTransformFn, UnifyInternVLAInputsTransformFn


@DatasetConfig.register_subclass("internvla")
@dataclass
class InternVLADatasetConfig(DatasetConfig):
    height: int = 448
    width: int = 448
        ...
        default_factory=lambda: TransformGroup(
            inputs=[
                ...
                ResizeImagesWithPadFn(
                    height=InternVLADatasetConfig.height, 
                    width=InternVLADatasetConfig.width, 
                ),  # ✅
                InternVL3TokenizerTransformFn(),  # ✅
                NormalizeTransformFn(),  # ✅
                ComposeFieldsTransform(),  # ✅
                PadStateAndActionTransformFn(
                    max_state_dim=InternVLADatasetConfig.max_state_dim, 
                    max_action_dim=InternVLADatasetConfig.max_action_dim, 
                ),  # ✅
                RemapImageKeyTransformFn(),  # ✅
                UnifyInternVLAInputsTransformFn(),  # ✅
            ],
            outputs=[]
        )
    )
