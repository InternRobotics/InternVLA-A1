...
@DataTransformFn.register_subclass("qwen_3_processor")
@dataclass
...
@DataTransformFn.register_subclass("unify_qwenvla_inputs")
@dataclass
class UnifyQwenVLAInputsTransformFn(DataTransformFn):
    def __call__(self, data: DataDict) -> DataDict: 
        data = {
