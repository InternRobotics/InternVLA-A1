...
from lerobot.policies.qwenvla.transform_qwenvla import Qwen3_VLProcessorTransformFn, UnifyQwenVLAInputsTransformFn


@DatasetConfig.register_subclass("qwenvla")
@dataclass
class QwenVLADatasetConfig(DatasetConfig):
    height: int = 224
    width: int = 224
        ...
        default_factory=lambda: TransformGroup(
            inputs=[
                ...
                ResizeImagesWithPadFn(
                    height=QwenVLADatasetConfig.height, 
                    width=QwenVLADatasetConfig.width, 
                ),  # ✅
                ...
                PadStateAndActionTransformFn(
                    max_state_dim=QwenVLADatasetConfig.max_state_dim, 
                    max_action_dim=QwenVLADatasetConfig.max_action_dim, 
                ),  # ✅
                UnifyQwenVLAInputsTransformFn(), 
            ],
            outputs=[]
        )
    )
...
@PreTrainedConfig.register_subclass("qwenvla")
@dataclass
